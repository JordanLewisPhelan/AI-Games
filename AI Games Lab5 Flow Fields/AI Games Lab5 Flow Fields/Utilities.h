...
namespace Utilities
{
	...
	*/
	...
	// Using inline to prevent other similarly variables named causing issues - not that it should happen but for safety - and its a nifty fun fact i just learned
